	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">PetquShop Putra</a></h1>
			</div>
												...
												<figure>
													<div class="snipcart-item block" >
														<div class="snipcart-thumb">
															<a href="product.php?idproduk=<?php echo $p['idproduk'] ?>"><img title="kucing3.jpg" alt=" " src="<?php echo $p['gambar']?>" width="200px" height="200px" /></a>		
...
<script type="text/javascript">
		jQuery(document).ready(function(){
			jQuery('#demo1').skdslider({'delay':0, 'animationSpeed': 2000,'showNextPrev':true,'showPlayButton':true,'autoSlide':false,'animationType':'fading'});
